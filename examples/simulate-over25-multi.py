# Look for roughly even teams with more than evens on 2.5 goals before the game at the start.
# The place bets on team less likely to win and then 2.5 goals.
...
class BackEvensStrategy(BaseStrategy):
    ...
    def process_market_book(self, market: Market, market_book: MarketBook) -> None:
        ...
        for runner in market_book.runners:
            print(runner_id_to_name[runner.selection_id])
...
strategy = BackEvensStrategy(
    ...
    market_filter= {
        "markets": data_files,  
        'market_types':['OVER_UNDER_25', 'MATCH_ODDS'],
